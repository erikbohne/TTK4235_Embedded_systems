...
De største delen av programmet er de ulike state modulene. Oversikten over disse moduelne og hvordan de hanger sammen kan du se i Figur \ref{fig:state_machine} På generelt grunnlag bstår implementasjonen i hovedsak av if statments som sammsvarer til spesifikasjonene fra oppgaven.
